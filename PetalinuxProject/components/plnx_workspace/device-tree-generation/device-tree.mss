...
BEGIN OS
 ...
 PARAMETER periph_type_overrides = {BOARD ovrly }
END
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = I2C_JA
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi_iic
 PARAMETER HW_INSTANCE = I2C_Shield
END
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = SPI_OLED
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi_qspi
 PARAMETER HW_INSTANCE = SPI_Shield
END
